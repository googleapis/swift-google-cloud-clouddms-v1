...
public struct DatabaseInstanceEntity: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DatabaseInstanceEntity`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DatabaseInstanceEntity().with { $0.customFeatures = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.clouddms.v1.DatabaseInstanceEntity"
  }
