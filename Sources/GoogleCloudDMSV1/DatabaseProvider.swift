...
public enum DatabaseProvider: Codable, Equatable, Sendable {
  ...
  public var stringValue: Swift.String? {
    switch self {
    case .unspecified: return "DATABASE_PROVIDER_UNSPECIFIED"
    case .cloudsql: return "CLOUDSQL"
    case .rds: return "RDS"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:DatabaseProvider/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "DATABASE_PROVIDER_UNSPECIFIED": self = .unspecified
    case "CLOUDSQL": self = .cloudsql
    case "RDS": self = .rds
    case "AURORA": self = .aurora
    case "ALLOYDB": self = .alloydb
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:DatabaseProvider/unknownIntValue(_:)).
