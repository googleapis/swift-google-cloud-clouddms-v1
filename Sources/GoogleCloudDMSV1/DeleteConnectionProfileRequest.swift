...
public struct DeleteConnectionProfileRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteConnectionProfileRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteConnectionProfileRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.clouddms.v1.DeleteConnectionProfileRequest"
  }
