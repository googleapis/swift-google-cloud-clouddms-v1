  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = DescribeConversionWorkspaceRevisionsResponse().with { $0.revisions = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ConversionWorkspace].self, forKey: .revisions) {
