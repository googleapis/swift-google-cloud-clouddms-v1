...
public struct GetMappingRuleRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetMappingRuleRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetMappingRuleRequest().with { $0.name = ... }
  /// ```
