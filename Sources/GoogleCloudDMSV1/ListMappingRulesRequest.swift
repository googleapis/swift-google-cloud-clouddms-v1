...
public struct ListMappingRulesRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMappingRulesRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMappingRulesRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.clouddms.v1.ListMappingRulesRequest"
  }
