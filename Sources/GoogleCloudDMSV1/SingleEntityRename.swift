...
/// Synonym
public struct SingleEntityRename: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Required. The new name of the destination entity
  public var newName: Swift.String = Swift.String()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `SingleEntityRename`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SingleEntityRename().with { $0.newName = ... }
  /// ```
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let newName = CodingKeys(stringValue: "newName")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(Swift.String.self, forKey: .newName) {
      self.newName = value
    }
